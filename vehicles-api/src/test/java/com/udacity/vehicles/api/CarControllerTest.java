...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        /**
         * _TODO: Add a test to check that the `get` method works by calling
         *   the whole list of vehicles. This should utilize the car from `getCar()`
         *   below (the vehicle will be the first in the list).
         */
        System.out.println("listCars test start");
        ...
        System.out.println("listCars test end");
    }
    ...
    public void deleteCar() throws Exception {
        /**
         * _TODO: Add a test to check whether a vehicle is appropriately deleted
